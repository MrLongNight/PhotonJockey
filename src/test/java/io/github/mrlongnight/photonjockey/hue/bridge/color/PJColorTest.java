...
class PJColorTest {
    ...
    void getDerivedColor_withZeroBound_returnsSameColor() {
        PJColor base = new PJColor(0.33f, 0.5f);
    ...
    void getDerivedColor_respectsBound_andRanges() {
        PJColor base = new PJColor(0.75f, 0.40f);
        double bound = 0.05;
    ...
    void isSimilar_returnsTrueForEquality() {
        PJColor a = new PJColor(0.12f, 0.34f);
        PJColor b = new PJColor(a.getRGB());
    ...
    void isSimilar_hueWrapAround_consideredSimilar() {
        PJColor a = new PJColor(0.99f, 1.0f);
        PJColor b = new PJColor(0.01f, 1.0f);
    ...
    void isSimilar_saturationIsNonCyclical_andRespectsBound() {
        PJColor lowSat = new PJColor(0.5f, 0.10f);
        PJColor highSat = new PJColor(0.5f, 0.90f);

        assertFalse(lowSat.isSimilar(highSat, 0.2), "Large saturation difference should not be similar");

        PJColor nearSat = new PJColor(0.5f, 0.28f);
    ...
    void equalsAndHashCode_byRgb() {
        PJColor a = new PJColor(0.2f, 0.8f);
        PJColor b = new PJColor(a.getRGB());
        PJColor c = new PJColor(0.21f, 0.8f); // likely different rgb
