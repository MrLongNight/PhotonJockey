...
import io.github.mrlongnight.photonjockey.gui.swing.*;
import io.github.mrlongnight.photonjockey.gui.util.BrowserLauncher;
...
import io.github.mrlongnight.photonjockey.hue.visualizer.HueBeatObserver;
import io.github.mrlongnight.photonjockey.util.UpdateChecker;
...
public class MainFrame extends AbstractFrame implements BeatObserver {
    ...
    public MainFrame(Config config, AppTaskOrchestrator taskOrchestrator,
        ...
        deviceHelpButton.addActionListener(e -> BrowserLauncher.openUrl("https://photonjockey.io/audioguide"));
        ...
        urlLabel.addMouseListener(new MouseInputAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                BrowserLauncher.openUrl("https://photonjockey.io");
            }
        });
        ...
        lightThemeCheckbox.setSelected("Light".equals(config.get(ConfigNode.THEME)));
        lightThemeCheckbox.addActionListener(e -> {
            config.put(ConfigNode.THEME, lightThemeCheckbox.isSelected() ? "Light" : "Dark");
    ...
    public void createUIComponents() {
        ...
        lightThemeCheckbox = new JCheckBox("Light Theme");
    }
            ...
            try {
                ...
                if (updateChecker.isUpdateAvailable()) {
                    int answerCode = JOptionPane.showConfirmDialog(
                            ...
                            JOptionPane.YES_NO_OPTION);
                    if (answerCode == 0) {
                        BrowserLauncher.openUrl("https://photonjockey.io/?downloads");
