...
public class UpdateChecker {
    ...
    private static final boolean UPDATE_CHECKER_DISABLED = Boolean.getBoolean("photonjockey.updatechecker.disabled");
    // URL to get the latest release information from the GitHub API
    private static final String URL_STRING = "https://api.github.com/repos/MrLongNight/PhotonJockey/releases/latest";
    ...
    public boolean isUpdateAvailable() {
        ...
        if (isNewerVersion(currentVersionString, latestVersionString)) {
            logger.info("Update to PhotonJockey version {} found (current is {})", latestVersionString, currentVersionString);
            return true;
        }
    ...
    public String getVersionString() throws Exception {
        ...
        connection.setRequestProperty("User-Agent", "PhotonJockey-Update-Checker");
